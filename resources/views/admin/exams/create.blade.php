                                ...
                                <div  class="col-md-12 newQuestion">
                                    <div class="form-group row">
                                        <div class="col-sm-6 row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="radio" id="inputMCQ" name="q_type0" value="0" >
                                            </div>
                                        </div>
                                        <div class="col-sm-6 row">
                                            <label for="inputCorrection" class="col-sm-4 control-label">@lang('site.exam question correct')</label>
                                            <div class="col-sm-8">
                                                <input type="radio" id="inputCorrection" name="q_type0" value="1">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            @error('q_type')
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 row">
                                            <div class="form-group col-sm-6 row">
                                                <input type="radio" value ="1" name="q0">
                                            ...
                                            <div class="form-group col-sm-6 row">
                                                <input type="radio" value ="2" name="q0">
                                        ...
                                        <div class="col-sm-12 row mcq">
                                            <div class="form-group col-sm-6 row mcq_answer">
                                                <input type="radio" value ="3" name="q0">
                                            ...
                                            <div class="form-group col-sm-6 row mcq_answer">
                                                <input type="radio" value ="4" name="q0">
