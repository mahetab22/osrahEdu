        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="active">@lang('site.questions')</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="card">
            ...
            <a class="btn bg-gradient-primary text-white" href="{{url('/admin/questions/create')}}">@lang('site.create new question')</a>
            <button class="btn bg-gradient-primary text-white delete_all"> {{ __('site.Delete All Selected') }}</button>
                <h3 class="card-title">@lang('site.questions')</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped table-hover">
                ...
                @foreach($questions as $i => $question)
                  <tr data-row-id='{{ $service->id }}'>
                      <td><input type="checkbox" name="questions[]" class="sub_chk" data-id="{{$question->id}}"></td>
                      <td><img src="{{url('/')}}/{{$question->logo}}" width="100px"/></td>
                      <td>{{$question->questions}}</td>
                      <td>{{$question->exam_id}}</td>
                      <td>{{$question->description_ar}}</td>
