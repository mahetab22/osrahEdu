        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">@lang('site.services')</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="card">
            ...
            <a class="btn bg-gradient-primary text-white" href="{{url('/admin/services/create')}}">@lang('site.create new services')</a>
            <button class="btn bg-gradient-primary text-white delete_all"> {{ __('site.Delete All Selected') }}</button>
                <h3 class="card-title">@lang('site.services')</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped table-hover">
                <thead>
                    <tr>
                        ...
                        <th>@lang('site.service arabic title')</th>
                        <th>@lang('site.service english title')</th>
                        <th>@lang('site.service arabic description')</th>
                        <th>@lang('site.service english description')</th>
                        <th> </th>
                    </tr>
                </thead>
                <tbody>
                @foreach($services as $i => $service)
                  <tr data-row-id='{{ $service->id }}'>
                      <td><input type="checkbox" name="services[]" class="sub_chk" data-id="{{$service->id}}"></td>
                      <td><img src="{{url('/')}}/{{$service->logo}}" width="100px"/></td>
                      ...
                      <td>
                          <div class="row">
                              <div class="col-md-6">
                                  <a class="edit btn bg-gradient-primary" href="{{ url('/admin/services/'.$service->id.'/edit') }}"><i class="fa fa-edit text-white"></i></a>
                              </div>
                              <div class="col-md-6">
                                  <a class="delete btn bg-gradient-danger m-1" href="javascript:void(0)" data-delete-id="{{ $service->id }}"><i class="fa fa-trash text-white"></i></a>
                              </div>
                          </div>
                      </td>
                  </tr>
