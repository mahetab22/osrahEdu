    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <li class="breadcrumb-item active">@Lang('site.create new services')</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-12">
                ...
                <!-- form start -->
                    <form class="form-horizontal" method="POST" action="{{ url('admin/services') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
