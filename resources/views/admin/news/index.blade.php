      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="card">
            ...
            <a class="btn bg-gradient-primary text-white" href="{{url('/admin/news/create')}}">@lang('site.create new')</a>
            <button class="btn bg-gradient-primary text-white delete_all"> {{ __('site.Delete All Selected') }}</button>
                <h3 class="card-title">@lang('site.news')</h3>
            </div>
            <!-- /.card-header -->
              ...
              <table id="example1" class="table table-bordered table table-head-fixed table-striped table-hover">
                ...
                @foreach($news as $i => $new)
                  <tr data-row-id='{{ $new->id }}'>
                      <td><input type="checkbox" name="news[]" class="sub_chk" data-id="{{$new->id}}"></td>
                      <td><img src="{{url('/')}}/{{$new->logo}}" width="100px"/></td>
                      <td>{{$new->title}}</td>
                      ...
                      <td>
                          <div class="row">
                              <div class="col-md-6">
                                  <a class="edit btn bg-gradient-primary" href="{{ url('/admin/news/'.$new->id.'/edit') }}"><i class="fa fa-edit text-white"></i></a>
                              </div>
                              <div class="col-md-6">
