...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>@lang('site.teacher subscriptions')</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="card">
            ...
            <a class="btn bg-gradient-primary text-white" href="{{url('/admin/teacher/subscripe/create/'.$supervisor)}}">@lang('site.subscripe courses')</a>
            {{--  <button class="btn bg-gradient-primary text-white delete_all"> {{ __('site.Delete All Selected') }}</button>  --}}
                <h3 class="card-title">@lang('site.teacher subscriptions')</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped table-hover">
                <thead>
                    <tr>
                        ...
                        <th>{{ app()->getLocale() == 'ar' ? __('site.course arabic title') : __('site.course english title') }}</th>
                        <th>{{ app()->getLocale() == 'ar' ? __('site.course arabic description') : __('site.course english description') }}</th>
                        <th> </th>
                    </tr>
                </thead>
                <tbody>
        ...
        Swal.fire({
          ...
          cancelButtonText: "@lang('site.alert_cancel')"
            ...
            if (result.isConfirmed) {
                ...
                url: "{!! url('admin/teacher/subscripe/delete/' ) !!}" + "/" + id,
                success:function(data){
                    Swal.fire({
                        position: 'center',
                        icon: data['alert']['icon'],
