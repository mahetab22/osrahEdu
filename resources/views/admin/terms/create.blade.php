    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-12">
                ...
                <!-- form start -->
                    <form class="form-horizontal" method="POST" action="{{ url('admin/terms') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('title_ar') {{  'is-invalid'  }} @enderror" id="inputTitle1" name="title_ar" value="{{ old('title_ar') }}" placeholder="@lang('site.terms arabic title')" required>
                                    @error('title_ar')
                            ...
                            {{--
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control @error('title_en') {{  'is-invalid'  }} @enderror" id="inputTitle2" name="title_en" value="{{ old('title_en') }}" placeholder="@lang('site.terms english title')" required>
                                        @error('title_en')
                                        <div class="text-danger"><small class="font-weight-bold">{{ $message }}</small></div>
                                        @enderror
                                    </div>
