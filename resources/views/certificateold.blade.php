...
<!--        <link href="css/style-en.css" rel="stylesheet" type="text/css" />-->
    ...
    <body>
		...
		<section class="cer-s" id="cre-sss">
            <div class="logo-cer">
                <img src="{{ asset('public/src_website/images/logo.png') }}" />
            </div>
            <div class="text-inner-ce" id="content-inner">
                <h1>شهادة اكمال دورة</h1>
                <h4>تشهد منصة نهل التعليمية بأن</h4>
 ...
 direction: ltr;">{{ $certificate->created_at->format('M-D-Y ')  }} </span>
                ...
                <div class="dd-lo"><img src="{{ asset('public/src_website/images/logo.png') }}" /></div>
            </div>
            <div id="editor"></div>
