...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>@lang('site.said_about_us')</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('/')}}/admin">@lang('site.admin_panel')</a></li>
              <li class="breadcrumb-item active">@lang('site.said_about_us')</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="card">
            ...
            <a class="btn bg-gradient-primary text-white" href="{{url('/admin/said/about/us/create')}}">@lang('site.create new')</a>
            <button class="btn bg-gradient-primary text-white delete_all"> {{ __('site.Delete All Selected') }}</button>
                <h3 class="card-title">@lang('site.said_about_us')</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                @foreach($aboutes as $i => $about)
                  <tr data-row-id='{{ $about->id }}'>
                      <td><input type="checkbox" name="abouts[]" class="sub_chk" data-id="{{$about->id}}"></td>
                      <td><img src="{{url('/')}}/{{$about->photo}}" width="100px"/></td>
                      ...
                      <td>
                          <div class="row">
                              <div class="col-md-6">
                                  <a class="edit btn bg-gradient-primary" href="{{ url('/admin/said/about/us/'.$about->id.'/edit') }}"><i class="fa fa-edit text-white"></i></a>
                              </div>
                              <div class="col-md-6">
                                  <a class="delete btn bg-gradient-danger m-1" href="javascript:void(0)" data-delete-id="{{ $about->id }}"><i class="fa fa-trash text-white"></i></a>
                              </div>
                          </div>
                      </td>
                  </tr>
        ...
        Swal.fire({
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{!! url('admin/said/about/us/delete_all' ) !!}",
                        type: 'POST',
        ...
        Swal.fire({
          ...
          cancelButtonText: "@lang('site.alert_cancel')"
            ...
            if (result.isConfirmed) {
                ...
                url: "{!! url('admin/said/about/us/' ) !!}" + "/" + id,
                success:function(data){
                    Swal.fire({
                        position: 'center',
                        icon: data['alert']['icon'],
