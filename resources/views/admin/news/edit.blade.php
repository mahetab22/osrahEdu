    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-12">
                ...
                <!-- form start -->
                    <form class="form-horizontal" method="POST" action="{{ url('admin/news/'.$new->id) }}" enctype="multipart/form-data">
                        @csrf
                        {{ method_field('PUT') }}
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('title') {{  'is-invalid'  }} @enderror" value="{{$new->title}}" id="inputName1" name="title"  placeholder="@lang('site.title')" required>
                                    @error('title')
                                        <div class="text-danger"><small class="font-weight-bold">{{ $message }}</small></div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('short_desc') {{  'is-invalid'  }} @enderror" id="inputName1" name="short_desc" value="{{ $new->short_desc }}" placeholder="@lang('site.short_desc')">
                                    @error('short_desc')
                                        <div class="text-danger"><small class="font-weight-bold">{{ $message }}</small></div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="desc" class="form-control @error('desc') {{  'is-invalid'  }} @enderror">{{ $new->desc }}</textarea>
                                    @error('desc')
                                        <div class="text-danger"><small class="font-weight-bold">{{ $message }}</small></div>
                                    @enderror
                                </div>
