        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{url('/')}}/admin/activities/{{$activity->course->id}}">@lang('site.activities')</a></li>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                @foreach($activity->student_activity as $i => $activity)
                  <tr data-row-id='{{ $activity->id }}'>
                      ...
                      <td><a href="{{url('/')}}/public/{{$activity->activity}}" download><i class="fa fa-download"></i></a></td>
        ...
        Swal.fire({
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{!! url('admin/activities/delete_all_student_activity' ) !!}",
                        type: 'POST',
