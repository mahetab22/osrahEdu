...
<!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@Lang('site.update teacher')</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ url('admin/teachers') }}">@lang('site.teachers')</a></li>
                    <li class="breadcrumb-item active">@Lang('site.update teacher')</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <!-- form start -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('name_ar') {{  'is-invalid'  }} @enderror" id="inputName1" name="name_ar" value="{{ $teacher->name }}" placeholder="@lang('site.teacher arabic name')" required>
                                    @error('name_ar')
                                        <div class="text-danger"><small class="font-weight-bold">{{ $message }}</small></div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('educational') {{  'is-invalid'  }} @enderror" id="inputEducational1" name="educational" value="{{ $teacher->Educational }}" placeholder="@lang('site.teacher educational')" required>
                                    @error('educational')
                                        <div class="text-danger"><small class="font-weight-bold">{{ $message }}</small></div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control @error('service_id') {{  'is-invalid'  }} @enderror" id="inputService1" name="service_id" value="{{ old('service_id') }}" placeholder="@lang('site.service')" required>
                                        ...
                                        <option value="{{ $service->id }}" {{ $service->id == $teacher->service_id ? 'selected' : '' }} > {{ app()->getLocale() ? $service->title_ar : $service->title_en  }} </option>
                                        @endforeach
                                    </select>
                                    @error('service_id')
                                        <div class="text-danger"><small class="font-weight-bold">{{ $message }}</small></div>
                    ...
                    <div class="card card-info">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('facebook') {{  'is-invalid'  }} @enderror" id="inputFacebook1" name="facebook" value="{{ $teacher->fb }}" placeholder="@lang('site.facebook')">
                                    @error('facebook')
                                        <div class="text-danger"><small class="font-weight-bold">{{ $message }}</small></div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('twitter') {{  'is-invalid'  }} @enderror" id="inputTwitter1" name="twitter" value="{{ $teacher->tw }}" placeholder="@lang('site.twitter')">
                                    @error('twitter')
                                        <div class="text-danger"><small class="font-weight-bold">{{ $message }}</small></div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('instagram') {{  'is-invalid'  }} @enderror" id="inputInstagram1" name="instagram" value="{{ $teacher->inst }}" placeholder="@lang('site.instagram')">
                                    @error('instagram')
                                        <div class="text-danger"><small class="font-weight-bold">{{ $message }}</small></div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('google') {{  'is-invalid'  }} @enderror" id="inputGoogle1" name="google" value="{{ $teacher->google }}" placeholder="@lang('site.google url')">
                                    @error('google')
                                        <div class="text-danger"><small class="font-weight-bold">{{ $message }}</small></div>
                                    @enderror
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control @error('curriculum_ar') {{  'is-invalid'  }} @enderror" id="inputCurriculumAr1" name="curriculum_ar" value="{{ $teacher->profile }}" placeholder="@lang('site.teacher arabic curriculum')">
                                        @error('curriculum_ar')
                                            <div class="text-danger"><small class="font-weight-bold">{{ $message }}</small></div>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control @error('skill1_ar') {{  'is-invalid'  }} @enderror" id="inputSkillAr1" name="skill1_ar" value="{{ $teacher->skill1 }}" placeholder="@lang('site.teacher arabic skill1')">
                                        @error('skill1_ar')
                                            <div class="text-danger"><small class="font-weight-bold">{{ $message }}</small></div>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control @error('skill2_ar') {{  'is-invalid'  }} @enderror" id="inputSkillAr2" name="skill2_ar" value="{{ $teacher->skill2 }}" placeholder="@lang('site.teacher arabic skill2')">
                                        @error('skill2_ar')
                                            <div class="text-danger"><small class="font-weight-bold">{{ $message }}</small></div>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control @error('skill3_ar') {{  'is-invalid'  }} @enderror" id="inputSkillAr3" name="skill3_ar" value="{{ $teacher->skill3 }}" placeholder="@lang('site.teacher arabic skill3')">
                                        @error('skill3_ar')
                                            <div class="text-danger"><small class="font-weight-bold">{{ $message }}</small></div>
                                        @enderror
                                    </div>
