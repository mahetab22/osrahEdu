    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <li class="breadcrumb-item active">@Lang('site.add new book')</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-12">
                ...
                <!-- form start -->
                    <form class="form-horizontal" method="POST" action="{{ url('admin/library') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('short_desc') {{  'is-invalid'  }} @enderror" id="inputName1" name="short_desc" value="{{ old('short_desc') }}" placeholder="@lang('site.book short desc')">
                                    @error('short_desc')
                                        <div class="text-danger"><small class="font-weight-bold">{{ $message }}</small></div>
                                    @enderror
                                </div>
